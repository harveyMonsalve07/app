...
use App\Http\Requests\PersonaActualizacion;
use App\Persona;
...
class PersonasController extends Controller
{
     ...
     * @return \Illuminate\Http\Response
     */
    public function update(PersonaActualizacion $request, Persona $persona)
    {
        $persona->actualizar($request);

        session()->flash('message', '¡Persona Actualizada! :D');
