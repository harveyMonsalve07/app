...
class PersonaCreacion extends FormRequest
{
	/**
	...
	*/
	public function rules()
	{
		...
		$validacion = [
			...
			'numero_identificacion' => "required|integer|digits_between:{$caracteres_min},{$caracteres_max}|unique:personas,numero_identificacion",
